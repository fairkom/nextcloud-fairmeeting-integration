OC.L10N.register(
	"fairmeeting",
	{
		...
		"fairmeeting Integration": "„fairmeeting“ integracija",
		Conferences: "Konferencijos",
		"fairmeeting Integration (unofficial)":
			"„fairmeeting“ integracija (neoficiali)",
		"Loading …": "Įkeliama…",
		save: "įrašyti",
		saved: "įrašyta",
		"Saving …": "Įrašoma…",
		...
		"Problems detected": "Aptikta problemų",
		...
		"Cannot copy, please copy the link manually":
			"Nepavyksta nukopijuoti, nukopijuokite nuorodą rankiniu būdu",
		"Copy to clipboard": "Kopijuoti į iškarpinę",
		Browser: "Naršyklė",
		"non-optimal": "neoptimali",
		"not supported": "nepalaikoma",
		"Audio and video quality could be poor.<br> It is recommended to use a recent <b>Firefox/Chrome/Chromium</b> version.":
			"Garsas ir vaizdas gali būti prastos kokybės.<br> Rekomenduojama naudoti naujausią <b>Firefox/Chrome/Chromium</b> versiją.",
		Help: "Pagalba",
		Camera: "Kamera",
		"Name of the new room": "Naujo kambario pavadinimas",
		...
		"Known problems / what you can try":
			"Žinomos problemos / ką galite išbandyti",
		"Does not work?": "Neveikia?",
		"Your browser (%1$s) is outdated and<br>no longer supported":
			"Jūsų naršyklė (%1$s) yra pasenusi ir<br>daugiau nebepalaikoma",
		"It is recommended to use the latest version of one of the following browsers:":
			"Rekomenduojama naudoti naujausią vieną iš šių naršyklių versiją:",
	},
