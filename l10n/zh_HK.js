OC.L10N.register(
	...
	{
		conferences: "會議",
		"fairmeeting Integration": "fairmeeting 整合",
		Conferences: "會議",
		"fairmeeting Integration (unofficial)": "fairmeeting 整合（非官方）",
		"This app integrates fairmeeting conferences into Nextcloud.\n\nFeatures:\n- 🎥 Easy online conferences in Nextcloud utilising fairmeeting\n- 🔗 Sharable conference room links\n- 🔎 Shows conference rooms in the global search\n- ✅ System test before joining a conference\n\nPlease read the [documentation](https://github.com/nextcloud/fairmeeting).":
			"此應用程式將 fairmeeting 會議整合到 Nextcloud 中。\n\n特點：\n- 🎥 利用 fairmeeting 在 Nextcloud 中輕鬆召開在線會議\n- 🔗 可共享的會議室連結\n- 🔎 在全球搜索中顯示會議室\n- ✅ 加入會議前的系統測試\n\n請閱讀[說明書] (https://github.com/nextcloud/fairmeeting)。",
		"Loading …": "加載中 ...",
		"Server URL (required)": "伺服器 URL（必填）",
		"Help link (optional)": "幫助連結（非強制的）",
		'Display "Join using the fairmeeting app"':
			"顯示“使用 fairmeeting 應用程式加入”",
		...
		saved: "已保存",
		"Saving …": "儲存中 ...",
		"Please provide a fairmeeting instance URL": "請提供 fairmeeting 實例 URL",
		"The server URL must start with https://":
			"伺服器 URL 必須以 https:// 開頭",
		"It is highly recommended to set up a dedicated fairmeeting instance":
			"強烈建議設置專用 fairmeeting 實例",
		...
		"Audio and video quality could be poor. It is recommended to use a recent <b>Firefox/Chrome/Chromium</b> version.":
			"音頻和視像質量可能很差。建議使用最新的 <b>Firefox / Chrome / Chromium</b> 版本。",
		...
		"Join with mobile app": "使用流動應用程序加入",
		"App button not working?": "應用程式按鈕不起作用？",
		"Download the desktop app here ↗": "在這裡下載桌上應用程式↗",
		"The mobile app is available via the app store of your choice.":
			"該流動應用程式可通過您選擇的應用程式商店獲得。",
		...
		"Still not working? Copy the link below and paste it into the input field on the fairmeeting App start screen.":
			"還是不行？複製下面的連結，粘貼到 fairmeeting 應用程式開始界面的輸入框裡。",
		"Link copied": "已複製連結",
		...
		"Audio and video quality could be poor.<br> It is recommended to use a recent <b>Firefox/Chrome/Chromium</b> version.":
			"音頻和視像質量可能很差。<br>建議使用最新的 <b>Firefox / Chrome / Chromium</b> 版本。",
		Help: "支援",
		Camera: "相機",
		...
		"Does not work?": "不行？",
		"Click here for troubleshooting help": "單擊此處獲取檢修幫助",
